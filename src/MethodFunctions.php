...
* @method \TelegramBot\Api\Methods\{createNewStickerSet} initCreateNewStickerSet(integer $userId, string $name, \TelegramBot\Api\Extension\InputFile|string $pngSticker, string $emojis, boolean $containsMasks = false, \TelegramBot\Api\Types\MaskPosition $maskPosition)
...
* @method \TelegramBot\Api\Methods\{addStickerToSet} initAddStickerToSet(integer $userId, string $name, \TelegramBot\Api\Extension\InputFile|string $pngSticker, string $emojis, \TelegramBot\Api\Types\MaskPosition $maskPosition)
